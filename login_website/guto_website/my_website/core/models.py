...
class PerfilUsuario(models.Model):
    ...
    complete_name = models.ForeignKey(CadastroUsuario, on_delete=models.CASCADE, related_name='perfil_usuario', null=True, blank=True)
    
    def __str__(self):
        return self.complete_name.username